      ...
      <nav className="fixed top-0 w-full z-50 bg-[#0B132B]/80 backdrop-blur border-b border-neonYellow">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <ul className="hidden md:flex items-center gap-8 font-pixel text-xs text-white/70">
            <li><button onClick={() => goToSection("about")} className="hover:text-neonYellow">ABOUT</button></li>
            <li><button onClick={() => goToSection("events")} className="hover:text-neonYellow">EVENTS</button></li>
            <li><button onClick={() => goToSection("team")} className="hover:text-neonYellow">TEAM</button></li>
            <li><button onClick={() => goToSection("levels")} className="hover:text-neonYellow">PATH</button></li>

            {/* Mute */}
            <button
              onClick={() => setMuted(toggleMute())}
              className="text-neonYellow hover:text-white"
            >
